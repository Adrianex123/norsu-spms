...
import Reacts, { useEffect, useRef, useState } from "react";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`z-9999 w-80.5 absolute left-0 top-0 flex h-screen flex-col overflow-y-hidden bg-sky-700 duration-300 ease-linear lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="py-5.5 lg:py-6.5 flex items-center justify-between gap-2 px-6">
        <Link href="/">
          <Image width={176} height={32} src={lgs} alt="Logo" priority />
        </Link>
