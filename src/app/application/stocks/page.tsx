...
export default function Stocks() {
  return (
    <div className="container py-2 mx-auto bg-gray-300   flex flex-col ">
      <div>
        ...
        <div className="h-full    w-full">
          <div className=" items-center px-4 justify-center">
            <div className="grid grid-cols-1 ">
              <div className="relative  h-[520px]  bg-white  rounded-3xl  ">
                <div>
                  <div className="flex w-full px-4 pt-4 gap-2 shrink-0 md:w-max">
                  ...
                  <div className="container pt-2 px-4">
                    <table className="  overflow-auto w-full ">
                      <thead className="border-b-2 px-1 border-gray-200">
                        <tr>
                      ...
                      <tbody className="text-right-2 px-2">
                        <tr>
                          <td>123</td>
                          <td>IT Dept</td>
                          <td> John</td>
