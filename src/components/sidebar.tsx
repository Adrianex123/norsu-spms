...
export default function Sidebar() {
  return (
    <div
      className="    sm:[w-18%] 
    md:w-[23%]  lg:w-[16%]  sidebar h-[642px] flex flex-col place-items-center bg-[#17134e] py-8 px-8 gap-2"
    >
      <Image src={lgs} className="w-full" alt="Picture of Logo" />

      <div className="flex  pt-2  flex-col links w-full gap-2 ">
        <Link
          href="/application"
        ...
        <Link
          ...
          className="box  hover:stroke-black py-2 text-white  text-base font-extrabold  rounded-lg  flex items-center gap-2.5  duration-300 ease-in-out"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
